...
plot(x_dense, p_df,'r-', 'DisplayName', 'Interpolant'); hold on; % plotting the interpolant
plot(x_dense, df_exact, 'b--', 'DisplayName', 'Exact')   % plotting the exact derivative

legend show;
title('fs Derivative Approximation');
xlabel('x'); 
ylabel('f''(x)');
hold off
...
semilogy(x_dense, abs_error, 'k-'); % plotting error
